  ...
  docsSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        'ai-for-engineering/build-and-train-your-own-gpt2-model/intro',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/01-problem-with-rnns-lstms',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/02-token-embeddings',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/03-positional-embeddings',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/04-attention-multi-head-attention',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/05-causal-masking',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/06-residual-connections',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/07-layer-normalization',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/08-feed-forward-neural-networks',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/09-generation-of-next-tokens',
        'ai-for-engineering/build-and-train-your-own-gpt2-model/10-decoder-only-transformer',
