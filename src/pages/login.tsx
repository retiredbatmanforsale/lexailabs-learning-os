...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>Sign In - Lex AI</title>
        <meta name="description" content="Sign in to your Lex AI account" />
      </Head>
      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex w-full flex-col justify-center px-8 py-12 lg:w-1/2 lg:px-16 xl:px-24">
          <div className="mx-auto w-full max-w-md">
            ...
            <p className="mb-8 text-base text-gray-500">Sign in to continue your learning journey</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="cursor-pointer text-sm text-blue-600 hover:underline">Forgot password?</span>
              </div>
